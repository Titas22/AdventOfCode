...
# lines = open("./inputs/2022/in_2022--09_test.txt") do file
# lines = open("./inputs/2022/in_2022--09_test2.txt") do file
lines = open("./inputs/2022/in_2022--09.txt") do file
    lines = readlines(file);
end
moves   = Move.(lines)

@time println("\nPart 1 answer: $(getNUniqueVisited(moves, 2))");
@time println("\nPart 2 answer: $(getNUniqueVisited(moves, 10))");
# printVisited(moveRope(moves, 2));
# printVisited(moveRope(moves, 10));